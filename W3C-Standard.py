#!/usr/bin/python3
"""
W3C validator created by Moifore Jallah (Student: Software Engineer at ALX-SE program)
For HTML and CSS files.
Based on 1 API:
- https://validator.w3.org/docs/api.html
Usage:
Simple file: used to test single HTML/CSS file
```
./w3c_standard.py index.html
```
Multiple files: used to test multiple HTML/CSS files
```
./w3c_standard.py index.html header.html styles/styles.css
```
...
if __name__ == "__main__":
    ...
    """
    if len(sys.argv) < 2:
        __print_stderr("usage: w3c_standard.py file1 file2 ...\n")
        exit(1)
